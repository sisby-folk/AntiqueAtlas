package folk.sisby.antique_atlas.surveyor;
...
public class SurveyorChunkUtil {
    ...
    public TileType terrainToTile(World world, ChunkPos pos) {
    ...
    public TileType toTileTypeNether(World world, ChunkPos pos) {
        Multiset<TileType> possibleTiles = HashMultiset.create(world.getRegistryManager().get(RegistryKeys.BIOME).size());
        Registry<Biome> biomeRegistry = world.getRegistryManager().get(RegistryKeys.BIOME);
    ...
    public TileType toTileTypeEnd(World world, ChunkPos pos) {
        Multiset<TileType> possibleTiles = HashMultiset.create(world.getRegistryManager().get(RegistryKeys.BIOME).size());
        Registry<Biome> biomeRegistry = world.getRegistryManager().get(RegistryKeys.BIOME);
