...
public class GuiAtlas extends GuiComponent {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float par3) {
        ...
        AntiqueAtlasTextures.BOOK.draw(matrices, getGuiX(), getGuiY());
        ...
        RenderSystem.setShaderColor(1, 1, 1, 1);
        AntiqueAtlasTextures.BOOK_FRAME.draw(matrices, getGuiX(), getGuiY());
        ...
        AntiqueAtlasTextures.BOOK_FRAME_NARROW.draw(matrices, getGuiX(), getGuiY());
    ...
    private void renderPlayer(MatrixStack matrices, double iconScale) {
        ...
        AntiqueAtlasTextures.PLAYER.drawCenteredWithRotation(matrices, playerOffsetX, playerOffsetY, (int) Math.round(PLAYER_ICON_WIDTH * iconScale), (int) Math.round(PLAYER_ICON_HEIGHT * iconScale), playerRotation);
